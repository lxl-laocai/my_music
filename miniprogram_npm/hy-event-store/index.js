...
__DEFINE__(1650268496012, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1650268496013,"./event-store":1650268496014}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1650268496013, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1650268496014, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1650268496013,"./utils":1650268496015}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1650268496015, function(require, module, exports) {
...
return __REQUIRE__(1650268496012);
})()
